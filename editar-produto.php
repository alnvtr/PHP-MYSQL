<?php
//adcionar funcionalida pra manter marcado o tipo, ou vallidar se o tipo foi marcado
    ...
    <form method="post" enctype="multipart/form-data">
      ...
      <div class="container-radio">
        <div>
            ...
            <input type="radio" id="cafe" name="tipo" value="Café" <?= $produto->getTipo() == "Café"? "cheked" : ""?>>
        </div>
        <div>
            <label for="almoco">Almoço</label>
            <input type="radio" id="almoco" name="tipo" value="Almoço"  <?= $produto->getTipo() == "Amoço"? "cheked" : ""?>>
        </div>
    </div>
